...
application {
    mainModule = "is.codion.demo.llemmy.openai"
    mainClass = "is.codion.demo.llemmy.openai.Runner"
...
jlink {
    ...
    mergedModule {
        ...
        uses("dev.langchain4j.model.openai.internal.spi.OpenAiClientBuilderFactory")
        uses("dev.langchain4j.model.openai.spi.OpenAiChatModelBuilderFactory")
