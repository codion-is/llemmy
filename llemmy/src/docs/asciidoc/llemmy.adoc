...
We start by creating a `Chat` interface and defining the domain API constants for the table and its columns, providing the table and column names as parameters.
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatPanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatEditModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatEditPanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatTableModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatTablePanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/app/model/LlemmyAppModel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/app/ui/LlemmyAppPanel.java[lines=19..-1]
----
...
[source,java,options="nowrap"]
----
include::{dir-openai}/llemmy/src/main/java/is/codion/demo/llemmy/openai/Runner.java[lines=19..-1]
----
