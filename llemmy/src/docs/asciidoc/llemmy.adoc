...
The domain model is created by extending the *DomainModel* class and defining a *DomainType* constant identifying the domain model.
...
We use the `EntityFormatter.builder()` method to build a formatter providing the `toString()` implementation for entities of this type.
