...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatModel.java[tags=chat_model]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatPanel.java[tags=chat_panel]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatEditModel.java[tags=chat_edit_model]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatEditPanel.java[tags=chat_edit_panel]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/model/ChatTableModel.java[tags=chat_table_model]
----
...
[source,java,options="nowrap"]
----
include::{dir-source}/is/codion/demos/llemmy/ui/ChatTablePanel.java[tags=chat_table_panel]
----
